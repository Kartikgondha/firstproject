...
function Home(props) {
    return (
        <div>
            <div className="kartik_bg position-relative">
                <div className="container">
                    <div className="col-6 kartik_position">
                        <h3 className="mb-4">Men New Seasson</h3>
                        <h1 className="text-uppercase display-2">Jackets &amp; Coats</h1>
                        <button type="button" className="btn btn-primary mt-4">Shop Now</button>
                    </div>
                </div>
            </div>
