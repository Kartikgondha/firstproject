                ...
                <div className="wrap-menu-desktop">
                    <nav className="limiter-menu-desktop container">
                        ...
                        <div className="wrap-icon-header flex-w flex-r-m">
                            <NavLink to={"/login"} className="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 js-show-modal-search">
                                {/* <i className="zmdi zmdi-search" /> */}
                                <i class="fa-solid fa-user kartik_size" ></i>
                            </NavLink>
                            <NavLink to={"/features"} className="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify={2}>
