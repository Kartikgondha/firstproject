      ...
      <div className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
        ...
        <div className="block2">
          <div className="block2-pic hov-img0">
            ...
            <NavLink to={"/shopdetail"}className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">Quick View
            </NavLink>
          </div>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Herschel supply
              </NavLink>
              <span className="stext-105 cl3">
                $35.31
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Only Check Trouser
              </NavLink>
              <span className="stext-105 cl3">
                $25.50
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Classic Trench Coat
              </NavLink>
              <span className="stext-105 cl3">
                $75.00
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Front Pocket Jumper
              </NavLink>
              <span className="stext-105 cl3">
                $34.75
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Vintage Inspired Classic 
              </NavLink>
              <span className="stext-105 cl3">
                $93.20
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Shirt in Stretch Cotton
              </NavLink>
              <span className="stext-105 cl3">
                $52.66
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Pieces Metallic Printed
              </NavLink>
              <span className="stext-105 cl3">
                $18.96
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Converse All Star Hi Plimsolls
              </NavLink>
              <span className="stext-105 cl3">
                $75.00
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Femme T-Shirt In Stripe
              </NavLink>
              <span className="stext-105 cl3">
                $25.85
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">T-Shirt with Sleeve
              </NavLink>
              <span className="stext-105 cl3">
                $18.49
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Pretty Little Thing
              </NavLink>
              <span className="stext-105 cl3">
                $54.79
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">       Mini Silver Mesh Watch
              </NavLink>
              <span className="stext-105 cl3">
                $86.85
              </span>
        ...
        <div className="block2">
          ...
          <div className="block2-txt flex-w flex-t p-t-14">
            <div className="block2-txt-child1 flex-col-l ">
              ...
              <NavLink to={"/shopdetail"} className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">Square Neck Back
              </NavLink>
              <span className="stext-105 cl3">
                $29.64
              </span>
